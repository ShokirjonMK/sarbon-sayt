                ...
                <div className="container mx-auto">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-[12px]">
                            <a href="https://www.instagram.com/sarbon.university" target="_blank" className="hover:rotate-12 transition"  >
                            ...
                            <a href="https://t.me/sarbon_university" target="_blank" className="hover:rotate-12 transition">
                            ...
                            <a href="https://www.youtube.com/channel/UC9hgqzWdHmNt0J-zaierVsg" target="_blank" className="hover:rotate-12 transition">
                            ...
                            <a href="https://www.facebook.com/sarbonuniversity.uz" target="_blank" className="hover:rotate-12 transition">
